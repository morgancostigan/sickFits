...
function (_Component) {
  ...
  function DeleteItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      //1. read cache looking for items we want
      var data = cache.readQuery({
        query: _Items__WEBPACK_IMPORTED_MODULE_3__["ALL_ITEMS_QUERY"]
      });
      console.log(data, payload); //2. filter deleted item out of page
      // data.items = data.items.filter( item => item.id !== payload.data.deleteItem)
    });
...
//# sourceMappingURL=items.js.0d2adf9ccd56889c8086.hot-update.js.map